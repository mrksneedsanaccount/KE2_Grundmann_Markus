...
// fehlersuche
    ...
    void initializeConversions(Object[] args, String md5) throws IOException, NoSuchAlgorithmException {
        ...
        src.propra.imageconverter.ImageConverter.main((String[]) args);
//
...
//            src.propra.conversion_facilitators.Encode encode = new Encode(commandLineInterpreter);
//            encode.exectueConversion();
//
//        } else if (test.startsWith(ProjectConstants.DECODE)) {
//            src.propra.conversion_facilitators.Decode decode = new Decode(commandLineInterpreter);
